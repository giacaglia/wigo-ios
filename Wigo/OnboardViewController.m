...
- (void)initializeAnimatedGif {
    ...
    FLAnimatedImageView *imageView = [[FLAnimatedImageView alloc] initWithFrame:CGRectMake(15, 50, self.view.frame.size.width - 130, [[UIScreen mainScreen] bounds].size.width)];
    ...
    FLAnimatedImageView *imageView2 = [[FLAnimatedImageView alloc] initWithFrame:CGRectMake(15, 50, self.view.frame.size.width - 130, [[UIScreen mainScreen] bounds].size.width)];
    ...
    FLAnimatedImageView *imageView3 = [[FLAnimatedImageView alloc] initWithFrame:CGRectMake(15, 50, self.view.frame.size.width - 130, [[UIScreen mainScreen] bounds].size.width)];
